...
* Why should reacting on state variable changes, two-way binding of state variables to form elements and other things  be harder to do in React than in other frameworks?
* They shouldn't and **react-easier** makes sure they aren't 😊. 

#### Install
Install the latest stable version (//version//) of **react-easier** in your project:
...
Version //version// of **react-easier** is small - //size// (~//gzipped// gzipped) and dependency free. (Check more size details on [bundlephobia.com](https://bundlephobia.com/result?p=react-easier)).
...
The **mountAndImport** feature allows you to start your app by mounting the component that you want, where you want in your HTML.
...
#### How?
Replace the whole content of **main.jsx** (the starting point of your app) with the following:
